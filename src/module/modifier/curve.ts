...
class Curve {
  sourceModule: any;
  controlPoints: number[][]; // @TODO write a tuple interface - is an array of pairs

  constructor(sourceModule, controlPoints) {
  ...
  insertAtPos(position: number, input: number, output: number) {
  ...
  addControlPoint(input: number, output: number) {
